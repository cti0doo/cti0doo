...
class ReportCertificationReportIca(models.Model):
    _name = 'certification_report.ica'
    _description = 'Colombian ICA certification report'
    _inherit = 'certification_report'
...
class ReportCertificationReportIva(models.Model):
    _name = 'certification_report.iva'
...
class ReportCertificationReportFuente(models.Model):
    _name = 'certification_report.fuente'
